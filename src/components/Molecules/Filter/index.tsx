    ...
    <section className="bg-secondary py-8 px-8 lg:px-0 w-full flex items-center justify-center">
      <div className="max-w-[1280px] w-full flex flex-col gap-8 items-center justify-center">
        <div className="flex flex-col gap-2 justify-center items-center">
          <h1 className="text-offWhite text-xl lg:text-3xl font-bold">ENCONTRE O SEMINOVO IDEAL</h1>
          <h3 className="text-offWhite text-lg lg:text-xl font-bold">AS MELHORES TAXAS ESTÃO AQUI!</h3>
        </div>
